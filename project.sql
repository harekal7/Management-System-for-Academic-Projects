...
--
-- Host: localhost
-- Generation Time: Mar 20, 2013 at 05:21 AM
...
INSERT INTO `project` (`Name`, `id`, `info`, `author`, `guide`, `year`, `PL`, `domain`) VALUES
...
('Management System for Academic Projects', 3, 'Project management software has a capacity to help plan, organize, and manage resource pools and develop resource estimates. Depending the sophistication of the software, resource including estimation and planning, scheduling, cost control and budget management, resource allocation, collaboration software, communication, decision-making, quality management and documentation or administration systems', 'Somashekhar', 'Phalachandra', 2008, 'HTML5, CSS3, Javascr', 'Web'),
('Faculty Adviser Automation', 4, 'The faculty member appointed to provide academic guidance and mentorship to a student through the completion of his or her graduate degree. Adviser and advisor are used interchangeably', 'Shivaraj', 'N S Kumar', 2009, 'Java', 'GUI based Desktop Application'),
('Sparse Matrix', 5, 'In the subfield of numerical analysis, a sparse matrix is a matrix populated primarily with zeros as elements of the table. Conceptually, sparsity corresponds to systems which are loosely coupled', 'Niranjan', 'H B Mahesh', 2011, 'C', 'Data-Structures');
...
INSERT INTO `users` (`usn`, `passwd`) VALUES
('1pi10cs116', '1pi10cs116'),
('1pi10cs115', '1pi10cs115'),
('1pi10cs105', '1pi10cs105'),
('1pi10cs089', '1pi10cs089'),
('1pi10cs113', '1pi10cs113');
