...
class FGMembersite
{
    ...
    function CheckLoginInDB($username,$password)
    {
        ...
        $pwdmd5 = md5($password);
        $qry = "Select id, username, email from $this->tablename where username='$username' and password='$pwdmd5' and confirmcode='y'";
    ...
    function SendUserConfirmationEmail(&$formvars)
    {
		...
		$to_name = $formvars['name'];
		$to = $formvars['email'];
		$subject = "Your registration with ".$this->sitename;;
		$message = "Hello ".$formvars['name']."\r\n\r\nThanks for your registration with ".$this->sitename."\r\nPlease click the link below to confirm your registration.\r\n".$confirm_url."\r\n\r\nRegards,\r\nKaper Labs\r\n".$this->sitename;
		$message = wordwrap($message,100);
		$from_name = "Kaper";
		$from = "kaper.pes@gmail.com";
		...
		$mail->SMTPAuth = true;
		$mail->SMTPSecure = "ssl";
		$mail->Username = "kaper.pes@gmail.com";
